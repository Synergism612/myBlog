...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `classify` VALUES (1,'测试分类','这是一个测试分类','2022-10-11 09:54:04','2022-10-11 09:54:04'),(2,'测试分类1','这是一个测试分类1','2022-10-12 01:45:46','2022-10-12 01:45:46'),(3,'新的分类','这是一个新的分类','2022-11-14 10:37:25','2022-11-14 10:37:25'),(7,'新的分类2','这是一个新的分类2','2022-11-14 10:38:22','2022-11-14 10:38:22');
...
CREATE TABLE `favorite` (
  ...
  `if_private` int(1) NOT NULL DEFAULT '0' COMMENT '私有  0-公开 1-私有',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='收藏夹表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `favorite` VALUES (1,'默认收藏夹','这是一个默认的收藏夹',0),(2,'大师傅阿斯蒂芬','阿斯蒂芬',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `file` VALUES (1,'测试','.txt','text',0.2,'book\\hello','.......','2022-11-19 11:30:27','2022-11-19 11:30:27'),(5,'icon','jpg','image/jpeg',70398,'111@qq.com\\blog\\icon\\\\icon.jpg','111@qq.com\\blog\\icon\\\\icon.jpg','2022-11-19 14:00:11','2022-11-19 14:00:11');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文件夹表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `folder` VALUES (1,'111@qq.com\\blog','blog',NULL,'2022-11-19 11:31:23','2022-11-19 12:50:09'),(10,'111@qq.com\\blog\\icon','icon',1,'2022-11-19 13:59:23','2022-11-19 13:59:23');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文件夹-文件对照表：文件夹下的文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `folder_file` VALUES (2,10,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文件仓库-文件对照表：文件仓库下文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repository_file` VALUES (1,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文件仓库-文件夹对照表：文件仓库下的文件夹';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repository_folder` VALUES (1,1,1);
...
INSERT INTO `user` VALUES (1,'','一二三四五六七八','1273059247@qq.com','vnpY8K8gHl/+5vBwsYFaZg==',NULL,0,'我是测试用户','2022-10-20 01:17:19','2022-10-21 13:13:42'),(2,'空','神和五律','111@qq.com','vnpY8K8gHl/+5vBwsYFaZg==','2017-01-04 16:00:00',1,'我叫神和五律','2022-10-20 01:19:02','2022-11-05 10:59:20');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户-分类对照表：用户创建的分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_classify` VALUES (2,1,1),(3,2,2),(4,2,3),(5,2,7);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户-收藏夹对照表：用户的收藏夹';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_favorite` VALUES (1,2,1),(2,2,2);
...
-- Dump completed on 2022-11-19 23:24:30
